...
plot.new()
hist(dane$price, freq = FALSE, main = "Histogram zmiennej price z krzywą gęstości", xlab = "price")
...
#Test T-studenta porównujący średnie ceny dla nieruchomości z i bez
klimatyzacji
...
grupami z i bez klimatyzacji (p \< 0,05).
